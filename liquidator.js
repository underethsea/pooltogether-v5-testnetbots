...
pairs = pairs.filter(pair => pair.LIQUIDATIONPAIR.toLowerCase() !== '0x0000000000000000000000000000000000000000');
    ...
    let allUndefined
geckos.length === 0 ? console.log("NO GECKO ID PRICES in constants/address.js to fetch") :allUndefined = geckos.every(element => element === undefined)

if(allUndefined){ console.log("NO GECKO IDS in constants/address.js")}
   // console.log(geckos);
