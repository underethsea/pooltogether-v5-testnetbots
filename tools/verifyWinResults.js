      ...
      for (let index of win.i) {
        ...
        if (BATCH_SIZE === 0) {
          ...
          if (result) {
            ...
            falseCount++;
          }}catch(e){console.log(`${e}`);console.log(`FALSE: Individual call for winner ${win.v}`);falseCount++}
        } else {
...
// Example usage
verifyWinners('11155420', '0x31547D3c38F2F8dC92421C54B173F3B27Ab26EbB', '68');
